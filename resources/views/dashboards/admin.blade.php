    ...
    <div class="text-center p-3">
        <div class="card my-2">
            ...
            <div class="card-footer text-left">
                ...
                @if(true)
                    <a href="#" class="text-decoration-none mx-1 text-warning"><i class="ti-na s-2x"
                                                                                  title=" عدم نمایش"></i></a>
                @else
                    <a href="#" class="text-decoration-none mx-1 text-warning"><i class="ti-eye s-2x"
                                                                                  title=" نمایش"></i></a>
        ...
        <div class="card my-2">
            ...
            <div class="card-footer text-left">
                <a href="{{ url('headers/1/edit') }}" class="text-decoration-none mx-1 text-success"><i
                            class="ti-pencil s-2x" title="ویرایش"></i></a>
                @if(true)
                    <a href="#" class="text-decoration-none mx-1 text-warning"><i class="ti-na s-2x"
                                                                                  title=" عدم نمایش"></i></a>
                @else
            ...
            <div class="card my-2">
                ...
                <div class="card-footer text-left">
                    <a href="{{ url("sections/$section->id/edit") }}" class="text-decoration-none mx-1 text-success">
                        <i class="ti-pencil s-2x" title="ویرایش"></i>
                    </a>
                    @if(true)
                        <a href="#" class="text-decoration-none mx-1 text-warning">
                            <i class="ti-na s-2x" title=" عدم نمایش"></i>
                        </a>
                    @else
                        <a href="#" class="text-decoration-none mx-1 text-warning">
                            <i class="ti-eye s-2x" title=" نمایش"></i>
                        </a>
